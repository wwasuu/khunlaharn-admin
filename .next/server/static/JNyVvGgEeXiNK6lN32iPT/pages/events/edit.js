...
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8);
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _components_common_Layout__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(9);
/* harmony import */ var _components_modal_gallery__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(13);
/* harmony import */ var _services__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(7);
...
function (_React$Component) {
  ...
  function EditEvent() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(EditEvent)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_getEvent",
    /*#__PURE__*/
    _asyncToGenerator(
    /*#__PURE__*/
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return _services__WEBPACK_IMPORTED_MODULE_9__[/* EventAPI */ "c"].getById(_this.props.router.query.id);

            case 3:
              res = _context.sent;

              _this.setState({
                event: _objectSpread({}, res.data.event, {
                  status: res.data.event.status === 1 ? true : false,
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_handleSubmit", function (e) {
      ...
      _this.props.form.validateFields(function (err, data) {
        ...
        _this._storeEvent(data);
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_storeEvent",
    /*#__PURE__*/
    function () {
      var _ref2 = _asyncToGenerator(
      /*#__PURE__*/
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                payload = _objectSpread({}, data, {
                  status: _this.state.event.status ? 1 : 0,
                  highlight: _this.state.event.highlight ? 1 : 0,
                  id: _this.state.event.id
                });
                ...
                _context2.next = 6;
                return _services__WEBPACK_IMPORTED_MODULE_9__[/* EventAPI */ "c"].edit(payload);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_changeStatus", function () {
      _this.setState({
        event: _objectSpread({}, _this.state.event, {
          status: !_this.state.event.status
        })
      });
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_changeHighlight", function () {
      _this.setState({
        event: _objectSpread({}, _this.state.event, {
          highlight: !_this.state.event.highlight
        })
      });
    });
  ...
  _createClass(EditEvent, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_common_Layout__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"], null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
        ...
        className: "_fs-4"
      }, "\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E01\u0E34\u0E08\u0E01\u0E23\u0E23\u0E21"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_3__["Button"], {
        loading: isLoading,
        icon: "save",
        className: "_mgr-8px",
        form: "form",
        ...
        initialValue: event.description_th,
        rules: [{
          required: true
        }]
        ...
        initialValue: event.description_en,
        rules: [{
          required: true
        }]
      })(react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(TextArea, {
        ...
        initialValue: moment__WEBPACK_IMPORTED_MODULE_6___default()(event.date),
        rules: [{
          required: true
        }]
      ...
      }, "Status")), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_3__["Switch"], {
      ...
      }, images && images.length ? react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
        ...
        className: "_mgbt-8px",
        icon: "picture"
      }, "\u0E40\u0E25\u0E37\u0E2D\u0E01\u0E23\u0E39\u0E1B\u0E20\u0E32\u0E1E")))))))), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_modal_gallery__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"], {
...
/* harmony default export */ __webpack_exports__["default"] = (antd__WEBPACK_IMPORTED_MODULE_3__["Form"].create()(Object(next_router__WEBPACK_IMPORTED_MODULE_4__["withRouter"])(EditEvent)));
