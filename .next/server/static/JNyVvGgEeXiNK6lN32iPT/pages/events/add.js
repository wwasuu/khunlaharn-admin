...
function (_React$Component) {
  ...
  function AddEvent() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(AddEvent)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_handleSubmit", function (e) {
      ...
      _this.props.form.validateFields(function (err, data) {
        ...
        _this._createEvent(data);
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_createEvent",
    /*#__PURE__*/
    function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 6;
                return _services__WEBPACK_IMPORTED_MODULE_8__[/* EventAPI */ "c"].create(payload);
...
/* harmony default export */ __webpack_exports__["default"] = (antd__WEBPACK_IMPORTED_MODULE_3__["Form"].create()(AddEvent));
