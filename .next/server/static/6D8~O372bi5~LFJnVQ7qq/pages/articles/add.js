...
/*#__PURE__*/
function (_React$Component) {
  _inherits(AddArticles, _React$Component);
  ...
  function AddArticles() {
    ...
    _classCallCheck(this, AddArticles);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(AddArticles)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(AddArticles, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_common_Layout__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"], null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
        ...
        className: "_fs-4"
      }, "\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E1A\u0E17\u0E04\u0E27\u0E32\u0E21"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_3__["Button"], {
        loading: isLoading,
        icon: "save",
        className: "_mgr-8px",
        form: "form",
...
/* harmony default export */ __webpack_exports__["default"] = (antd__WEBPACK_IMPORTED_MODULE_3__["Form"].create()(AddArticles));
