...
/*#__PURE__*/
function (_React$Component) {
  _inherits(AddKnowledge, _React$Component);
  ...
  function AddKnowledge() {
    ...
    _classCallCheck(this, AddKnowledge);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(AddKnowledge)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_handleSubmit", function (e) {
      ...
      _this.props.form.validateFields(function (err, data) {
        ...
        _this._createArticle(data);
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_createArticle",
    /*#__PURE__*/
    function () {
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                payload = _objectSpread({}, data, {
                  read_type: 'knowledge',
                  status: _this.state.data.status ? 1 : 0,
                  highlight: _this.state.data.highlight ? 1 : 0
                });
                ...
                _context.next = 6;
                return _services__WEBPACK_IMPORTED_MODULE_8__[/* ArticleAPI */ "a"].create(payload);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_changeStatus", function () {
      _this.setState({
        data: _objectSpread({}, _this.state.data, {
          status: !_this.state.data.status
        })
      });
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_changeHighlight", function () {
      _this.setState({
        data: _objectSpread({}, _this.state.data, {
          highlight: !_this.state.data.highlight
        })
      });
    });
  ...
  _createClass(AddKnowledge, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_common_Layout__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"], null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
        ...
        className: "_fs-4"
      }, "\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E04\u0E27\u0E32\u0E21\u0E23\u0E39\u0E49\u0E43\u0E2B\u0E21\u0E48"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_3__["Button"], {
        loading: isLoading,
        icon: "save",
        className: "_mgr-8px",
        form: "form",
        ...
        colon: false
      }, getFieldDecorator('video_url')(react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_3__["Input"], null))), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(FormItem, {
        label: "\u0E1C\u0E39\u0E49\u0E40\u0E02\u0E35\u0E22\u0E19",
        colon: false
...
/* harmony default export */ __webpack_exports__["default"] = (antd__WEBPACK_IMPORTED_MODULE_3__["Form"].create()(AddKnowledge));
