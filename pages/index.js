    ...
    const columns = [{
      ...
      render: (title_th, record)=>
        <div>
          ...
          <div className="_fs-8"><span><Link href={`/articles/edit?id=${record.id}`}><a>Edit</a></Link></span><span className="_mgh-8px">|</span><span className="_cs-pt" onClick={() => this._openModalRemove(record.id)}>Delete</span>
          </div>
        </div>,
      width: '60%'
    }, {
